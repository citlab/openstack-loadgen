...
create table if not exists SOURCETABLE_RICH (second integer, start integer, end integer, time integer, system text);
insert into SOURCETABLE_RICH select *, "HOST" as system from HOST.SOURCETABLE_RICH;
